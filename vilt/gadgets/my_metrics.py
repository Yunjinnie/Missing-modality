...
class F1_Score(Metric):
    ...
    def compute(self, use_sigmoid=True):
        ...
        if use_sigmoid:
            all_logits = torch.sigmoid(all_logits)
        F1_Micro = f1_score(all_logits, all_targets, 'multilabel', average='micro', num_labels=23)
        F1_Macro = f1_score(all_logits, all_targets, 'multilabel', average='macro', num_labels=23)
        #F1_Samples = f1_score(all_logits, all_targets, 'multilabel', average='samples', num_labels=23)
        F1_Weighted = f1_score(all_logits, all_targets, 'multilabel', average='weighted', num_labels=23)
        #
